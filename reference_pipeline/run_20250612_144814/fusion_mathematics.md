...
Transformation:
H_aligned = S * H + T
where S = 3.327521 (scale factor)
      T = [-0.027485183730176832, -0.0993339389312375, -0.39939335511996626] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 3.327521
    translation = np.array([-0.027485183730176832, -0.0993339389312375, -0.39939335511996626])
