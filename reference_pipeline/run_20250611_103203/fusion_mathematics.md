...
Transformation:
H_aligned = S * H + T
where S = 4.009361 (scale factor)
      T = [0.023761658979132926, -0.34532656129738054, -0.313459024769502] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 4.009361
    translation = np.array([0.023761658979132926, -0.34532656129738054, -0.313459024769502])
