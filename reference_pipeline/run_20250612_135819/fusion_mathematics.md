...
Transformation:
H_aligned = S * H + T
where S = 7.854062 (scale factor)
      T = [-0.0298366404833595, -0.34057624127904207, -0.12300115150513724] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 7.854062
    translation = np.array([-0.0298366404833595, -0.34057624127904207, -0.12300115150513724])
