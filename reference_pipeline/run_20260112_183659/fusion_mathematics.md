...
Transformation:
H_aligned = S * H + T
where S = 3.327780 (scale factor)
      T = [-0.027361045137545538, -0.09931805303642607, -0.3995997966190735] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 3.327780
    translation = np.array([-0.027361045137545538, -0.09931805303642607, -0.3995997966190735])
