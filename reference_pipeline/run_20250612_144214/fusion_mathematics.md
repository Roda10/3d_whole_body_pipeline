...
Transformation:
H_aligned = S * H + T
where S = 6.371115 (scale factor)
      T = [-0.002083706496355465, -0.4061545485620511, -0.08454468021363302] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 6.371115
    translation = np.array([-0.002083706496355465, -0.4061545485620511, -0.08454468021363302])
