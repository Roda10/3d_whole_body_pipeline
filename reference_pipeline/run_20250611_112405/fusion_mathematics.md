...
Transformation:
H_aligned = S * H + T
where S = 4.009102 (scale factor)
      T = [0.023753346846977767, -0.34529649749768254, -0.31344421149252893] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 4.009102
    translation = np.array([0.023753346846977767, -0.34529649749768254, -0.31344421149252893])
