...
Transformation:
H_aligned = S * H + T
where S = 4.009228 (scale factor)
      T = [0.023748350049839884, -0.34528250367580754, -0.3135096460806619] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 4.009228
    translation = np.array([0.023748350049839884, -0.34528250367580754, -0.3135096460806619])
