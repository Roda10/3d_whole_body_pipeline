...
Transformation:
H_aligned = S * H + T
where S = 7.854026 (scale factor)
      T = [-0.02983690807884729, -0.34057148682971283, -0.12300673432850776] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 7.854026
    translation = np.array([-0.02983690807884729, -0.34057148682971283, -0.12300673432850776])
