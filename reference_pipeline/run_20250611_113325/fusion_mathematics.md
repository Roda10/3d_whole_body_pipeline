...
Transformation:
H_aligned = S * H + T
where S = 4.021852 (scale factor)
      T = [-0.4177467712143762, 0.1588077007207827, -0.18064631305994552] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 4.021852
    translation = np.array([-0.4177467712143762, 0.1588077007207827, -0.18064631305994552])
