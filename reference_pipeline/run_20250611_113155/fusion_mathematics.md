...
Transformation:
H_aligned = S * H + T
where S = 5.416884 (scale factor)
      T = [0.24969545284575992, 0.18678834791888926, -0.38359873032294733] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 5.416884
    translation = np.array([0.24969545284575992, 0.18678834791888926, -0.38359873032294733])
