...
Transformation:
H_aligned = S * H + T
where S = 4.009098 (scale factor)
      T = [0.02374845985073204, -0.34531006799605857, -0.3134632292898459] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 4.009098
    translation = np.array([0.02374845985073204, -0.34531006799605857, -0.3134632292898459])
