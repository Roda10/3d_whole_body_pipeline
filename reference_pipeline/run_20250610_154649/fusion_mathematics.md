...
Transformation:
H_aligned = S * H + T
where S = 4.009374 (scale factor)
      T = [0.0237600137893074, -0.3453300188018479, -0.3134580223673008] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 4.009374
    translation = np.array([0.0237600137893074, -0.3453300188018479, -0.3134580223673008])
