...
Transformation:
H_aligned = S * H + T
where S = 3.326976 (scale factor)
      T = [-0.02739154381078605, -0.09935768478015843, -0.39955686886373654] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 3.326976
    translation = np.array([-0.02739154381078605, -0.09935768478015843, -0.39955686886373654])
