...
Transformation:
H_aligned = S * H + T
where S = 4.009357 (scale factor)
      T = [0.023768453906937825, -0.3453290388057723, -0.3134757036283495] (translation)
...
def fuse_models(smplx_params, wilor_params, emoca_params):
    ...
    scale = 4.009357
    translation = np.array([0.023768453906937825, -0.3453290388057723, -0.3134757036283495])
