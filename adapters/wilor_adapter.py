...
#             print("="*50)
#             print("WiLoR model output keys:", list(out.keys()))
...
#             print("\nMANO Parameters Structure:")
#             mano_params = out['pred_mano_params']
#             print(f"pred_mano_params type: {type(mano_params)}")
#             print(f"pred_mano_params keys: {list(mano_params.keys())}")
#             for param_key, param_value in mano_params.items():
#                 if hasattr(param_value, 'shape'):
#                     print(f"  {param_key}: {param_value.shape}")
#                 else:
#                     print(f"  {param_key}: {type(param_value)}")
#             print("="*50)
