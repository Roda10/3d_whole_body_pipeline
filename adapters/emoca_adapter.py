...
#         print("\n=== EMOCA Parameter Shapes ===")
#         for key in ['shapecode', 'texcode', 'expcode', 'posecode', 'cam', 'lightcode', 
#                     'detailcode', 'detailemocode', 'verts', 'landmarks2d', 'landmarks3d',
#                     'trans_verts', 'albedo']:
#             if key in vals and vals[key] is not None:
#                 if hasattr(vals[key], 'shape'):
#                     print(f"{key}: {vals[key].shape}")
#                 else:
#                     print(f"{key}: {type(vals[key])}")
#         # name = f"{i:02d}"
